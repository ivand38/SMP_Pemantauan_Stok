...
class PiutangCard extends StatelessWidget {
  final DetailHutangModel detailHutang;
  PiutangCard(this.detailHutang);
            ...
            children: [
              Flexible(
                child: Padding(
                  ...
                  child: Text(
                    detailHutang.nama_customer.toString(),
                ...
                children: [
                  ...
                  Text(
                    CurrencyFormat.convertToIdr(
                        int.parse(detailHutang.sisa_utang.toString())),
