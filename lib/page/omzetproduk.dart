...
import 'package:smp_app/widget/omzetproduk_card.dart';
...
class OmzetProductPage extends StatefulWidget {
  const OmzetProductPage({super.key});

  @override
  State<OmzetProductPage> createState() => _OmzetProductPageState();
}

class _OmzetProductPageState extends State<OmzetProductPage> {
  ...
  getInit() async {
    ...
    getDate();
    await Provider.of<OmzetProdukProvider>(context, listen: false)
        .getOmzetProduk();
    setState(() {
      _isLoading = false;
    });
  ...
  Future<DateTime?> getDate() async {
    ...
    await prefs.setString('daterange_omzetProduk',
  ...
  Widget build(BuildContext context) {
    ...
    OmzetProdukProvider omzetProdukProvider =
        Provider.of<OmzetProdukProvider>(context);
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
                    ...
                    children: [
                      ...
                      Column(
                          ...
                          children: searchText.isEmpty
                              ? omzetProdukProvider.omzetProduks
                                  .map((omzetProduk) =>
                                      OmzetProdukCard(omzetProduk))
                                  .toList()
                              : omzetProdukProvider.omzetProduks
