...
import 'package:smp_app/widget/detailsalescustomer_card.dart';
...
class DetailSalesCustomerPage extends StatefulWidget {
  final String omzetSalesman;
  const DetailSalesCustomerPage(this.omzetSalesman, {super.key});

  @override
  State<DetailSalesCustomerPage> createState() =>
      _DetailSalesCustomerPageState();
}

class _DetailSalesCustomerPageState extends State<DetailSalesCustomerPage> {
  ...
  getInit() async {
    ...
    await Provider.of<DetailSalesCustomerProvider>(context, listen: false)
        .getDetailSalesCustomer();
    setState(() {
      _isLoading = false;
    });
  }
  ...
  Widget build(BuildContext context) {
    DetailSalesCustomerProvider detailSalesCustomerProvider =
        Provider.of<DetailSalesCustomerProvider>(context);
    List sum_hutang = detailSalesCustomerProvider.detailSalesCustomers
    ...
    return SafeArea(
      child: Scaffold(
          ...
          body: _isLoading
              ...
              : detailSalesCustomerProvider.detailSalesCustomers.isEmpty
                  ? Container(
                                ...
                                children: [
                                  ...
                                  Column(
                                      ...
                                      children: searchText.isEmpty
                                          ? detailSalesCustomerProvider
                                              .detailSalesCustomers
                                              .map((detailSalesCustomer) =>
                                                  DetailSalesCustomerCard(
                                                      detailSalesCustomer))
                                              .toList()
                                          : detailSalesCustomerProvider
                                                  .detailSalesCustomers
                                              ...
                                              ? detailSalesCustomerProvider
                                                  ...
                                                  .where((element) => element
                                                      ...
                                                      .contains(searchText
                                                          .toLowerCase()))
                                                  .map((detailSalesCustomer) => DetailSalesCustomerCard(detailSalesCustomer))
                                                  .toList()
                                              : [
                                                  SizedBox(
                                                    height:
