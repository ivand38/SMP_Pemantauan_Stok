...
import 'package:smp_app/widget/omzetsalesman_card.dart';
...
class _OmzetSalesmanPageState extends State<OmzetSalesmanPage> {
  ...
  getInit() async {
    ...
    getDate();
    await Provider.of<OmzetSalesmanProvider>(context, listen: false)
        .getOmzetSalesman();
    setState(() {
      _isLoading = false;
    });
  ...
  Future<DateTime?> getDate() async {
    ...
    await prefs.setString('daterange_omzetSales',
  ...
  Widget build(BuildContext context) {
    ...
    OmzetSalesmanProvider omzetSalesmanProvider =
        Provider.of<OmzetSalesmanProvider>(context);
    return SafeArea(
      child: Scaffold(
                    ...
                    children: [
                      ...
                      Column(
                          ...
                          children: searchText.isEmpty
                              ? omzetSalesmanProvider.omzetSalesmans
                                  .map((omzetSalesman) =>
                                      OmzetSalesmanCard(omzetSalesman))
                                  .toList()
                              : omzetSalesmanProvider.omzetSalesmans
